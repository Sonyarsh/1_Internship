...
class ConcreteStrengthBase(BaseModel):
    ...
    a1_geometry: float = Field(..., alias='a_1')
    a2_geometry: float = Field(..., alias='a_2')
    a3_geometry: float = Field(..., alias='a_3')
    a4_geometry: float = Field(..., alias='a_4')
    ...
    h1_geometry: float = Field(..., alias='h_1')
    h2_geometry: float = Field(..., alias='h_2')
    h3_geometry: float = Field(..., alias='h_3')
    h4_geometry: float = Field(..., alias='h_4')
